const d = new Date();
const gregMonth = d.getMonth(); // Current month of the year (Gregorian)
const gregDay = d.getDate(); // Current day of the year (Gregorian)
...
var fuckMonths = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30] // This is why I hate the Gregorian calendar.
...
function convertToday() {
    if (dayOfYear == 365) {
        ...
        if (fixMonth >= 7) {
            fixMonth += 1;
        } // Check if the month 'sol' has passed
